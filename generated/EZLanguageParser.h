...
public:
  enum {
    ...
    T__38 = 39, OPERATOR = 40, LT = 41, GT = 42, COMMA = 43, BOOLEAN = 44, 
    IDENTIFIER = 45, STRING = 46, NUMBER = 47, LINE_COMMENT = 48, BLOCK_COMMENT = 49, 
    WS = 50
  };
  ...
  enum {
    ...
    RuleAssignmentStatement = 7, RuleBreakStatement = 8, RuleContinueStatement = 9, 
